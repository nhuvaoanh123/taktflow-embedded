 ...
 * @traces_to  SSR-BCM-001 to SSR-BCM-012, TSR-022, TSR-023, TSR-024
 *
...
static const Com_TxPduConfigType bcm_tx_pdu_config[] = {
    /* pduId,                      dlc, cycleMs */
    { BCM_COM_TX_LIGHT_STATUS,      8u, 100u },   /* CAN 0x400 — 100ms cyclic      */
    { BCM_COM_TX_INDICATOR_STATE,   8u, 100u },   /* CAN 0x401 — 100ms cyclic      */
    { BCM_COM_TX_DOOR_LOCK,         8u, 500u },   /* CAN 0x402 — on-change / 500ms */
};
...
static const Com_RxPduConfigType bcm_rx_pdu_config[] = {
    /* pduId,                     dlc, timeoutMs */
    { BCM_COM_RX_VEHICLE_STATE,    8u,  200u },   /* CAN 0x100 — 200ms timeout    */
    { BCM_COM_RX_MOTOR_CURRENT,    8u,  200u },   /* CAN 0x301 — 200ms timeout    */
    { BCM_COM_RX_BODY_CMD,         8u,  500u },   /* CAN 0x350 — 500ms timeout    */
};
