...
cubecvccfg/                             <- CubeMX project for CVC (manual)
cubefzccfg/                             <- CubeMX project for FZC (saved)
cuberzccfg/                             <- CubeMX project for RZC (manual)
...
**FZC: COMPLETE** — all 14 pins configured, project saved as `cubefzccfg/cubeFZCcfg.ioc`
...
|---------|------|--------|--------------------------|
| CVC | `cubecvccfg/` | Clock 170 MHz, FDCAN1, SYS | SPI1, I2C1, GPIO (PA4, PA15, PB0, PB4, PB5, PC13 EXTI) |
| FZC | `cubefzccfg/` | Clock 170 MHz, FDCAN1, SYS | SPI2, USART2, TIM2, GPIO (PB0, PB1, PB4, PB5, PB12) |
| RZC | `cuberzccfg/` | Clock 170 MHz, FDCAN1, SYS | ADC1 (6ch DMA), TIM1, TIM4 (encoder), GPIO (PB0, PB1, PB4) |

FZC saved as `cubefzccfg/cubeFZCcfg.ioc`. Clone for CVC and RZC, adjust peripherals.
