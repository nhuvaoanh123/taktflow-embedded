...
The script scans:
  ...
  2. Unit tests         — firmware/*/test/test_*.c, firmware/shared/bsw/test/test_*.c
  3. Integration tests  — test/integration/test_int_*.c
  4. SIL scenarios      — test/sil/scenarios/*.yaml
  5. Source code        — firmware/*/src/*.c, firmware/shared/bsw/**/*.c (excluding tests)
