...
class AppWindow(QMainWindow):
    ...
    def _build_toolbar(self):
        ...
        self._dbc_label = QLabel(f"taktflow.dbc ({len(self.decoder.db.messages)} msgs)")
    ...
    def _toggle_connection(self, checked):
        if checked:
            ...
            self._status_conn.setText(f"{port} @ 2Mbps ({self.reader.protocol})")
